...
def main():
    ...
    for two species.'''
    healthy_met_exchange_path = Path("Western_healthy_MES/mes_results_Western_healthy_MES.csv")
    healthy_MES_df = MES(healthy_met_exchange_path)

    CRC_met_exchnage_path = Path("Western_CRC_MES/mes_results_Western_CRC_MES.csv")
